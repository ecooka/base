...
public class MainActivity extends BaseStatusActivity {
    ...
    public void initData() {
        ...
        tabList.add(new TabViewPager.Tab("First", ImageFragment.instace("https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=565285572,2311431934&fm=27&gp=0.jpg")));
        tabList.add(new TabViewPager.Tab("Second", ImageFragment.instace("https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=1637535468,2612371482&fm=27&gp=0.jpg")));
        tabList.add(new TabViewPager.Tab("Third", ImageFragment.instace("https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=3104697540,4084345733&fm=27&gp=0.jpg")));
        tabList.add(new TabViewPager.Tab("Fourth", ImageFragment.instace("https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=3104697540,4084345733&fm=27&gp=0.jpg")));
        tabList.add(new TabViewPager.Tab("Fifth", ImageFragment.instace("https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=3104697540,4084345733&fm=27&gp=0.jpg")));
        tabList.add(new TabViewPager.Tab("Sixth", ImageFragment.instace("https://ss1.bdstatic.com/70cFvXSh_Q1YnxGkpoWK1HF6hhy/it/u=3104697540,4084345733&fm=27&gp=0.jpg")));
